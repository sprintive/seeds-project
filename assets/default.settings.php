 ...
 * @endcode
 */
$settings['hash_salt'] = '3beKCGaOfA-OijIvj250hytDmpAS9pKjGILG7TsoJdJ52U-PAp9bBjcKVuN9q7PKq9XiQQLYNA';
...
if (file_exists($local_settings)) {
  ...
  // Require HTTPS across all environments
...
// Require development services yaml if it exists.
$development_yaml = dirname(__FILE__) . '/development.services.yml';
if (file_exists($development_yaml)) {
  // Load development services yaml file.
  $settings['container_yamls'][] = $development_yaml;
}

// Enable fast404 settings if it exists.
$fast404_settings = dirname(__FILE__) . '/settings.fast404.php';
